...
// AddBalanceInTransaction provides a mock function with given fields: ctx, userID, amount, oldAmount, sign, tx
func (_m *UserAccountDao) AddBalanceInTransaction(ctx context.Context, userID int, amount int, oldAmount int, sign string, tx *gorm.DB) error {
	ret := _m.Called(ctx, userID, amount, oldAmount, sign, tx)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int, int, int, string, *gorm.DB) error); ok {
		r0 = rf(ctx, userID, amount, oldAmount, sign, tx)
	} else {
		r0 = ret.Error(0)
	}
...
// SubtractBalanceInTransaction provides a mock function with given fields: ctx, userID, amount, oldAmount, sign, tx
func (_m *UserAccountDao) SubtractBalanceInTransaction(ctx context.Context, userID int, amount int, oldAmount int, sign string, tx *gorm.DB) (int, error) {
	ret := _m.Called(ctx, userID, amount, oldAmount, sign, tx)
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int, int, int, string, *gorm.DB) (int, error)); ok {
		return rf(ctx, userID, amount, oldAmount, sign, tx)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int, int, int, string, *gorm.DB) int); ok {
		r0 = rf(ctx, userID, amount, oldAmount, sign, tx)
	} else {
		r0 = ret.Get(0).(int)
	}

	if rf, ok := ret.Get(1).(func(context.Context, int, int, int, string, *gorm.DB) error); ok {
		r1 = rf(ctx, userID, amount, oldAmount, sign, tx)
	} else {
		r1 = ret.Error(1)
	}
